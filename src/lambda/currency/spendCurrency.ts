/**
 * Lambda function for spending currency
 */
...
export const handler = async (
  ...
  try {
    ...
    const request: SpendCurrencyRequest = JSON.parse(event.body);
    ...
    // Update character currency and save transaction
    try {
      ...
      return {
        ...
        body: JSON.stringify({
          transaction,
          newBalance,
          message: `Spent ${request.amount} steam coins`,
        }),
      };
    } catch (dbError) {
