...
/**
 * CLI Runner for User Acceptance Tests
...
Usage:
  npx ts-node src/testing/userAcceptance/runUserAcceptanceTests.ts [options]

Options:
  --help, -h     Show this help message
  --verbose, -v  Enable verbose output
  --category, -c Specify test category to run (player-usage, offline-online, performance, usability)
...
Examples:
  ...
  npx ts-node src/testing/userAcceptance/runUserAcceptanceTests.ts --verbose
  
  # Run specific category
  npx ts-node src/testing/userAcceptance/runUserAcceptanceTests.ts --category player-usage

Test Categories:
  - player-usage: Tests typical player workflows and interactions
  - offline-online: Tests offline/online transitions and data synchronization
  - performance: Tests system performance under realistic load conditions
  - usability: Tests user interface and experience quality
